      ...
      <div className="max-w-[350px] sm:max-w-[700px] md:max-w-[725px] lg:max-w-4xl xl:max-w-[1400px] mx-auto w-auto bg-[#3d3a3a]/70 py-16 px-6 rounded-4xl">
        ...
        <div className="text-center max-w-6xl mx-auto ">
          ...
          <p className="text-white sm:text-[20px] md:text-xl lg:text-2xl xl:text-2xl mb-8 leading-relaxed max-w-full mx-auto">
            Feeling overwhelmed by digital marketing or left behind by bigger competitors? 
            Urbanzi Solutions, a digital marketing agency in Trivandrum, understands how confusing online growth can feel. 
            We listen to your challenges and create clear, effective campaigns—so your business gets seen, heard, and loved online
            </p>
        </div>
