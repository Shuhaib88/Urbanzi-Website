...
export default function OurWebDevServices() {
  return (
    <div className="px-4 mt-12 sm:px-6 lg:px-8">
      ...
      {/* Description */}
      <div className="font-bold text-lg sm:text-xl md:text-xl lg:text-2xl xl:text-2xl mt-4 sm:mt-5">
        <div className="flex justify-center font-bold text-center px-4">
          Everything You Need for a Standout Web Presence:
        </div>
      </div>
      ...
      <div className="flex flex-col items-center gap-4 sm:gap-6 p-4 sm:p-6">
        ...
        <button className="mt-4 sm:mt-6 px-4 py-2 sm:px-5 bg-white text-black text-xs sm:text-sm rounded-md border border-gray-700 hover:bg-gray-700 transition">
          See More
        </button>
      </div>
    </div>
